...
import mab.commander.npc.ai.MBEntityAIAttackMelee;
import mab.commander.npc.ai.MBEntityAIFollow;
import mab.commander.npc.ai.MBEntityAIStandGuard;
...
public abstract class EntityMBUnit extends EntityCreature{
	...
	public EntityMBUnit(World par1World, EnumTeam team, EnumUnits type) {
        ...
        this.tasks.addTask(7, new MBEntityAIFollow(this, this.moveSpeed, 5.0F, 2.0F));
